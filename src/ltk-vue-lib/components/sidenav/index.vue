<template>
  <div class="side-nav-container">
    <div class="vue-side-nav" :class="{'side-nav-expanded': expanded}">
      <nav-buttons :items="navigation"/>
      <div class="flex-fill"></div>
      <nav-buttons :items="utilities"/>
      <div class="width-100 f-row f-end button-container" @click="expand()">
    ...
    <div class="mask" v-if="showSubnav" @click="toggleSubnav($event)"></div>
  </div>
</template>
